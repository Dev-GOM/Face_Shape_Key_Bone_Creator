...
1. Find View3D > Sidebar > Shape Key Tools panel
...
1. View3D > Sidebar > Shape Key Tools 패널을 찾습니다
...
1. View3D > Sidebar > Shape Key Toolsパネルを開く
...
1. 找到View3D > Sidebar > Shape Key Tools面板
